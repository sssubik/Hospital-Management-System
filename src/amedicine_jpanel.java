...
public class amedicine_jpanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panel.add(DateExpiry);
        DateExpiry.setBounds(340, 250, 240, 40);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
         ...
         String Edate = ((JTextField) DateExpiry.getDateEditor().getUiComponent()).getText();
        if (!valid.isStringInt(TextName.getText())) {
            ...
            Error.setText("Stock must be Integer");
        }
         else {
    ...
    public JDateChooser getDateExpiry() {
        return DateExpiry;
    }
