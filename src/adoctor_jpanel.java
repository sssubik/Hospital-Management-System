...
public class adoctor_jpanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panel.add(TextAge);
        TextAge.setBounds(540, 140, 80, 30);
    ...
    public void setDid()
    {
       int i = 0;
        RepositoryClass Rc = new RepositoryClass();
        ResultSet rs = Rc.returnMaxDid();
        try{
            if(rs.next())
            {
            i = Integer.parseInt(rs.getString("Did"));
        ...
        i = i+1;
        TextDid.setText(Integer.toString(i));
    }
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String spec = String.valueOf(TextSpeciality.getSelectedItem());
        Validate valid = new Validate();
        if (!valid.isInteger(TextDid.getText())) {
        ...
        } else if (!valid.isString(spec)) {
            Error.setText("Speciality must be String");
        } 
         else {
            setTime();
