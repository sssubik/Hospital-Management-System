...
public void CurrentDate(){
    ...
    {
        LabelExpiry.setText("  Expiry Alert!!: " + Integer.toString(i));
    }
     public void setStock(int i)
    {
        StockAlert.setText("  Stock Alert!!: " + Integer.toString(i));
    }
    /**
    ...
    private void StockAlertMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_StockAlertMouseClicked
        // TODO add your handling code here:
         panel.removeAll();
        panel.setLayout(new GridLayout(1,2));
        //panel.add(new umedicine_jpanel());
    ...
    private javax.swing.JLabel StockAlert;
