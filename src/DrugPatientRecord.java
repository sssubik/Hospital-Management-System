 ...
 * @author rpran
 */
public class DrugPatientRecord extends javax.swing.JPanel {
...
/*
    ...
    */
    ...
    public void updateTable(OutPatientRecord O) {
        RepositoryClass Rc = new RepositoryClass();
        ResultSet rs = Rc.returnDiseasePatientRecord(O.getTableClick());
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Drug Patient Record");
        panel.add(jLabel2);
        jLabel2.setBounds(400, 0, 180, 40);
