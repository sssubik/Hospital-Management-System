 ...
 * @author rpran
 */
public class outpatient_jpanel extends javax.swing.JPanel {

    /**
     * Creates new form jpanel3
     */
    public outpatient_jpanel() {
        initComponents();
        CurrentDate();
        fillCombo();
    ...
    public void fillCombo()
    {
        ...
        ResultSet rs = Rc.viewDoctorCombo();
        try{
        while(rs.next())
        {
            String add1 = rs.getString("DoctorName");
            TextDName.addItem(add1);
        }
        }
        catch(Exception e)
        {
...
public void CurrentDate(){
        ...
        TextDateOfDischarge.setText(year+"-"+monthh+"-"+dayy);
    ...
    private void initComponents() {
        ...
        TextDateOfDischarge = new javax.swing.JTextField();
        ...
        TextDName = new javax.swing.JComboBox();
        ...
        jLabel2.setText("OUT-PATIENT CASE RECORD");
        panel.add(jLabel2);
        jLabel2.setBounds(390, 10, 210, 30);
        panel.add(TextAge);
        TextAge.setBounds(510, 120, 50, 30);

        jLabel3.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Name:");
        panel.add(jLabel3);
        jLabel3.setBounds(90, 130, 50, 17);
        ...
        panel.add(jLabel9);
        jLabel9.setBounds(470, 160, 70, 30);

        jLabel5.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Sex:");
        panel.add(jLabel5);
        jLabel5.setBounds(590, 117, 30, 30);
        ...
        TextContactNo.setBounds(560, 200, 190, 30);
        ...
        TextAddress.setBounds(560, 160, 240, 30);

        TextOpno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TextOpnoActionPerformed(evt);
            }
        });
        panel.add(TextOpno);
        ...
        jLabel4.setText("Age:");
        panel.add(jLabel4);
        jLabel4.setBounds(470, 120, 40, 30);
        ...
        panel.add(jLabel8);
        jLabel8.setBounds(470, 200, 100, 30);

        jLabel10.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Examined By:");
        panel.add(jLabel10);
        jLabel10.setBounds(90, 300, 100, 30);
        panel.add(TextDateOfDischarge);
        TextDateOfDischarge.setBounds(230, 210, 190, 30);

        jLabel11.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 255, 255));
        jLabel11.setText("Family Member:");
        panel.add(jLabel11);
        jLabel11.setBounds(90, 250, 110, 30);

        jLabel12.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Name:");
        panel.add(jLabel12);
        jLabel12.setBounds(210, 250, 50, 30);
        ...
        panel.add(TextFName);
        TextFName.setBounds(260, 250, 190, 30);

        jLabel13.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Contact No:");
        panel.add(jLabel13);
        jLabel13.setBounds(470, 250, 100, 30);
        ...
        TextFContactNo.setBounds(560, 250, 160, 30);

        jLabel14.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Date of Discharge:");
        panel.add(jLabel14);
        jLabel14.setBounds(90, 210, 140, 30);
        panel.add(TextDateOfAdmission);
        TextDateOfAdmission.setBounds(230, 170, 190, 30);

        jLabel15.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(255, 255, 255));
        jLabel15.setText("Digonosis:");
        panel.add(jLabel15);
        jLabel15.setBounds(90, 350, 100, 30);

        TextDiagnosis.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        TextDiagnosis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                TextDiagnosisActionPerformed(evt);
            }
        });
        ...
        panel.add(TextDName);
        TextDName.setBounds(210, 303, 170, 30);
        panel.add(TextSex);
        TextSex.setBounds(630, 120, 100, 30);
        panel.add(TextName);
        TextName.setBounds(150, 120, 290, 30);
        ...
        panel.add(jButton2);
        jButton2.setBounds(150, 50, 110, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
             ...
             {
                 Error.setText("Sorry OpNo must be Integer");
             }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
             DiseaseTable Dj = new DiseaseTable();
             Dj.setDiagnosis(this);
             Dj.setVisible(true);
    ...
    public void setDiagnosis(String Name)
    {
        ...
        TextDiagnosis.setText(Name);
        panel.updateUI();
    }
    private void TextDiagnosisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextDiagnosisActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TextDiagnosisActionPerformed

    private void TextOpnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextOpnoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_TextOpnoActionPerformed

    public void setTextDiagnosis(String TextDiagnosis) {
        this.TextDiagnosis.setText(TextDiagnosis);
    }
    ...
    public JTextField getTextDateOfDischarge() {
        return TextDateOfDischarge;
    }

    public JTextField getTextDiagnosis() {
    ...
    private javax.swing.JComboBox TextDName;
    private javax.swing.JTextField TextDateOfAdmission;
    private javax.swing.JTextField TextDateOfDischarge;
